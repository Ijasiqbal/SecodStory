...
function ProductCard() {
  ...
  const [products, setProducts] = useState([
    ...
    },
    {
      ...
      price: "180",
      image:
        "https://m.media-amazon.com/images/I/51bStGhF7WL._SY445_SX342_.jpg",
      tag: "Seller", // Sample tag type
    },
    {
      id: 3,
      ...
      price: "170",
      image:
        "https://m.media-amazon.com/images/I/51kkeE8Jv+L._SY445_SX342_.jpg",
    ...
    },
    {
      ...
      price: "222",
      image:
        "https://m.media-amazon.com/images/I/41LU+AaRIQL._SY445_SX342_.jpg",
      tag: "Seller", // Sample tag type
    },
    {
      id: 6,
      ...
      price: "201",
      image:
        "https://m.media-amazon.com/images/I/51nZpJeLf4L._SY445_SX342_.jpg",
      tag: "Seller", // Sample tag type
    },
    {
      id: 7,
      ...
      price: "200",
      image:
        "https://m.media-amazon.com/images/I/61V813zEOzL._SY445_SX342_.jpg",
      tag: "Seller", // Sample tag type
    },
    {
      id: 8,
      ...
      price: "199",
      image:
        "https://m.media-amazon.com/images/I/51JtK7GW3RL._SY445_SX342_.jpg",
      tag: "Seller", // Sample tag type
    },
    {
      id: 9,
      ...
      price: "129",
      image:
        "https://m.media-amazon.com/images/I/51gAQo24viL._SY445_SX342_.jpg",
      tag: "Lender", // Sample tag type
    },
    {
      id: 10,
      ...
      price: "99",
      image:
        "https://m.media-amazon.com/images/I/51IQsrtSbVL._SY445_SX342_.jpg",
      tag: "Seller", // Sample tag type
    },
    {
      id: 11,
    ...
    },
    {
      ...
      price: "159",
      image:
        "https://m.media-amazon.com/images/I/51EIc57chuL._SX342_SY445_.jpg",
      tag: "Seller", // Sample tag type
    },
    {
      id: 13,
      ...
      price: "109",
      image:
        "https://m.media-amazon.com/images/I/51wmswmIrRL._SX342_SY445_.jpg",
      tag: "Seller", // Sample tag type
    },
    {
      id: 14,
        ...
        {products.map((product) => (
          <div className="product" key={product.id}>
            <div className="product-image">
              ...
              <span
                className="seller-tag inside"
                style={{
                  backgroundColor:
                    product.tag === "Seller" ? "#EC9A78" : "#8878EC",
                }}
              >
                {product.tag}
              </span>
